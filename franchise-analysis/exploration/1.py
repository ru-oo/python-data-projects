...
with tab0:
    ...
    try:
        st.image("ppt_intro.png", caption="프로젝트 배경 및 개요", use_container_width=True)
    except:
    ...
    # 1. 이미지
    try:
        st.image("ppt_data.png", caption="Data Sources & Preprocessing Flow", use_container_width=True)
    except:
